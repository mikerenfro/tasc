...
interp_Jel = Final.int_Jel.*Sys_pick.*B_pick;
 ...
 %++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        Force_CMOD_fig = figure( 'Name','Force_vs_CMOD',...
    ...
    Snet_CMOD_fig = figure( 'Name','Snet_vs_CMOD',...
                             'NumberTitle','off','color', 'w');                   
    hold on
    ...
    Sfar_CMOD_fig = figure( 'Name','Sfar_vs_CMOD',...
                             'NumberTitle','off','color', 'w');                   
    hold on
    ...
    Jtotal_Snet_fig = figure( 'Name','Jtotal_vs_Snet',...
                             'NumberTitle','off','color', 'w');                    
    hold on
    ...
    %-------------------------------------------------------------- 
    Jelastic_Snet_fig = figure( 'Name','Jel_vs_Snet',...
                             'NumberTitle','off','color', 'w');                    
    hold on
    plot(interp_net_stress, interp_Jel(end,:),...
     ...
     hold off
    %-------------------------------------------------------------- 
    Jtotal_phi_fig = figure( 'Name','Jtotal_vs_phi',...
                             'NumberTitle','off','color', 'w');                    
    hold on
    plot(Final.interp_phi, interp_Jtotal(:,end),...
     ...
     hold off
    %-------------------------------------------------------------- 
    Jel_phi_fig = figure( 'Name','Jel_vs_phi',...
                             'NumberTitle','off','color', 'w');                    
    hold on
    plot(Final.interp_phi, interp_Jel(:,end),...
     ...
     %
     Jtotal_phi_CMOD_fig = figure( 'Name','Jtotal_vs_phi_CMOD',...
                             'NumberTitle','off','color', 'w');                    
    hold on
    plot(Final.interp_phi, interp_Jtotal(:,end),...
                    '-kp','LineWidth',2,...
